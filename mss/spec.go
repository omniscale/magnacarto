...
func init() {
	attributeTypes = map[string]isValid{
		...
		"line-pattern-cap":                isKeyword("round", "butt", "square"),
		"line-pattern-clip":               isBool,
		"line-pattern-comp-op":            isCompOp,
		"line-pattern-dasharray":          isNumbers,
		"line-pattern-file":               isString,
		"line-pattern-geometry-transform": isString,
		"line-pattern-join":               isKeyword("miter", "miter-revert", "round", "bevel"),
		"line-pattern-alignment":          isKeyword("global", "local"),
		"line-pattern-miterlimit":         isNumber,
		...
		"line-pattern-transform":          isString,
		"line-pattern-type":               isKeyword("warp", "repeat"),
		"line-pattern-width":              isNumber,
		...
		"text-upright":                  isKeyword("auto", "auto-down", "left", "right", "left-only", "right-only"),
