...
func TestScanner(t *testing.T) {
	for _, tt := range []struct {
		...
		{
			text: `#label { text-placement: {text-dy: 5}, {text-size: 10};}`,
			tokens: []tokVal{
				{tokenHash, "#label"},
				{tokenS, " "},
				{tokenLBrace, "{"},
				{tokenS, " "},
				{tokenIdent, "text-placement"},
				{tokenColon, ":"},
				{tokenS, " "},
				{tokenLBrace, "{"},
				{tokenIdent, "text-dy"},
		...
		{
			text: `#label { text-name: [name] + "\n" <Format size=9>[elev]</Format>;}`,
			tokens: []tokVal{
				{tokenHash, "#label"},
				{tokenS, " "},
				{tokenLBrace, "{"},
				{tokenS, " "},
				{tokenIdent, "text-name"},
				{tokenColon, ":"},
				{tokenS, " "},
				{tokenLBracket, "["},
				{tokenIdent, "name"},
